...
def main(window, chosen_character1, chosen_character2, name1, name2,lives):
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_w and player.jump_count < 2:
                    player.jump()
                    is_jumping = True
                elif event.key == pygame.K_UP and player2.jump_count < 2:
                    player2.jump()
                    is_jumping = True
        ...
        for fruit in fruits1:
            ...
            if fruit.rect.colliderect(player2.rect):
        ...
        if initial_player1_lives <= 0:
            ...
            win.main_menu("WIN",name2,chosen_character2)
...
if __name__ == "__main__":
    main(window, "MaskDude", "NinjaFrog","Hai","Kha",15)
