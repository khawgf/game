...
def main_menu():
    ...
    while running:
        ...
        draw_button(500, 330, 900, 550, LIGHTSKYBLUE, 10)
        draw_text("Fruit Fight Online", font, BLACK, 520, 90)
        draw_button(250, 320, 300, 380, YELLOW, 10)

        button_rect1 = draw_button_with_image("assets/Background/button.png", 145, 175, 60, 60)
        button_rect2 = draw_button_with_image("assets/Background/button.png", 215, 175, 60, 60)
        button_rect3 = draw_button_with_image("assets/Background/button.png", 285, 175, 60, 60)
        button_rect4 = draw_button_with_image("assets/Background/button.png", 355, 175, 60, 60)

        draw_button(760, 320, 300, 380, YELLOW, 10)
        button_rect5 = draw_button_with_image("assets/Background/button.png", 650, 175, 60, 60)
        button_rect6 = draw_button_with_image("assets/Background/button.png", 720, 175, 60, 60)
        button_rect7 = draw_button_with_image("assets/Background/button.png", 790, 175, 60, 60)
        button_rect8 = draw_button_with_image("assets/Background/button.png", 860, 175, 60, 60)


        draw_button_start(SCREEN_WIDTH - 200 // 2 - 70, SCREEN_HEIGHT - 50 // 2 - 50, 200, 50, WHITE, 10)
        draw_text("Start", font, BLACK, SCREEN_WIDTH - 270 // 2 - 30, SCREEN_HEIGHT - 50 // 2 - 50)
        ...
        if chosen_character:
            ...
            main_offline.Player_VEL_1 = character_stats[chosen_character]["velocity"]
            main_offline.speed_throw_1 = character_stats[chosen_character]["throw_speed"]
        ...
        if chosen_character2:
            player_offline_2.Player.SPRITES = player_offline_2.load_sprite_sheet("MainCharacters", chosen_character2, 32, 32, True)
            main_offline.Player_VEL_2 = character_stats[chosen_character2]["velocity"]
            main_offline.speed_throw_2 = character_stats[chosen_character2]["throw_speed"]
            player_offline_2.Player_jump = character_stats[chosen_character2]["jump_high"]
            character_frames = load_animation_frames(chosen_character2, 32, 32)
            if character_frames:
                current_time = pygame.time.get_ticks()
                if current_time - last_frame_update >= animation_speed * 1000:
                    frame_index += 1
                ...
                frame_index %= len(character_frames)  # Đảm bảo frame_index không vượt quá số lượng khung hình
                current_frame = character_frames[frame_index]
                screen.blit(current_frame, (700, 310))
        else:
            character_frames = load_animation_frames("MaskDude", 32, 32)
            if character_frames:
                current_time = pygame.time.get_ticks()
            ...
            if event.type == pygame.QUIT:
                ...
                if event.button == 1:
                    ...
                    if button_rect1.collidepoint(mouse_pos):
                        ...
                        chosen_character2 = "MaskDude"
                        button_clicked = True
                    elif button_rect6.collidepoint(mouse_pos):
                        chosen_character2 = "NinjaFrog"
                        button_clicked = True
                    elif button_rect7.collidepoint(mouse_pos):
                        chosen_character2 = "PinkMan"
                        button_clicked = True
                    elif button_rect8.collidepoint(mouse_pos):
                        chosen_character2 = "VirtualGuy"
                        button_clicked = True
                    elif SCREEN_WIDTH - 200 // 2 - 70 <= mouse_pos[0] <= SCREEN_WIDTH - 200 // 2 - 70 + 200 and \
     SCREEN_HEIGHT - 50 // 2 - 50 <= mouse_pos[1] <= SCREEN_HEIGHT - 50 // 2 - 50 + 50:
                        main_offline.main(screen, chosen_character, chosen_character2, "LS.HAI", "CSV.KHA",15)
